...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uplaodImage = findViewById(R.id.uploadImageBtn);
        ...
        String [] items = new String[]{"Select Category","Convocation","Independace Day ","Other Events"};
