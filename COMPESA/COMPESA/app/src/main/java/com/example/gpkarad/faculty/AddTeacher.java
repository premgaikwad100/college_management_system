...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items = new String[]{"Select Category","Computer Engineering","Mechanical Engineering", "Instrumentation Engineering", "Civil Engineering" };
    ...
    private void insertData() {
        ...
        dbRef.child(uniqueKey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(AddTeacher.this, "Teacher information added", Toast.LENGTH_SHORT).show();

                addTeacherName.setText(null);
                addTeacherEmail.setText(null);
                addTeacherPost.setText(null);
